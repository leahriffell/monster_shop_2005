...
RSpec.describe 'Merchant Dashboard' do
  before :each do
    ...
    @admin = User.create!(name:"US37", address:"bbbbbbb", city:"nnnnnnnn", state:"yyyyyyyy", zip:"88888", email: "iamadmin@gmail.com", password:"pass", password_confirmation:"pass", role: 2)
  ...
  describe "as an Admin" do
    ...
    it "can see merchant dashboard as an admin and see everything a merchant can see" do
      visit "/merchants"
      expect(page).to have_content(@bike_shop.name)
      expect(page).to have_link(@bike_shop.name)
