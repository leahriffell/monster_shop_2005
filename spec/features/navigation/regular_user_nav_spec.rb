...
RSpec.describe 'Site Navigation' do
  describe 'As a Regular user' do
    before :each do
      @user = User.create!(name:"Jackie Chan", address:"skdjfhdskjfh", city:"kajshd", state:"jsdh", zip:"88888", email: "iamking@gmail.com", password:"Iamapassword", password_confirmation:"Iamapassword", role: 0)
