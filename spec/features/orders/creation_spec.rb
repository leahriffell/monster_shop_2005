...
RSpec.describe("Order Creation") do
  describe "When I check out from my cart" do
    before(:each) do
      ...
      @user = User.create!(name:"Jackie Chan", address:"skdjfhdskjfh", city:"kajshd", state:"jsdh", zip:"88888", email: "54321@gmail.com", password:"Iamapassword", password_confirmation:"Iamapassword", role: 0)
