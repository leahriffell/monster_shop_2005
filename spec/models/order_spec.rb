...
describe Order, type: :model do
  ...
  describe 'instance methods' do
    before :each do
      ...
      @order_1 = @user.orders.create!(name: 'Meg', address: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17033, status?: true)
      @order_2 = @user.orders.create!(name: 'Phil', address: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17033, status?: false)
